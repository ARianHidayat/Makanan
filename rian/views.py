...
from hidayat.models import Transaksi, DetailTransaksi
...
from hidayat.forms import CartAddProductForm
from hidayat.keranjang import Cart
import datetime
...
def kategori(request, slug):
    ...
    cart_product_form = CartAddProductForm()
    halaman_tampil = Paginator(produk, 4)
